...
class WidgetEchartMapScatter extends React.Component 
{
    constructor( props )
    {
        super(props);
    ...
    convertData(data) 
    {
        ...
        for (let i = 0; i < data.length; i++) 
        {
            ...
            if( geoCoord ) 
            {
                ...
                item["value"] = geoCoord.concat(data[i].value);
    ...
    {    
        ...
        {
            config = {...WidgetEchartConfig.theme[chartOption.theme].mapScatterConfig, ...config};
        }
        else
        {
            config = {...WidgetEchartConfig.theme["default"].mapScatterConfig, ...config};
        }
...
export default WidgetEchartMapScatter