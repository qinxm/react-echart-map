...
class WidgetEchartRelation extends React.Component{
    constructor(props){
        super(props);
        this.state = {
                ...
                data: [
                  {
                    ...
                    //   position: "bottom",
                        ...
                        formatter: "{first|t_table}",
                        rich: {
                            first: {
                                backgroundColor: "rgb(242,199,40)",
                                color: "#fff",
                                align: "center",
                                width: 116,
                                height: 42,
    ...
    render(){
        ...
        {
            return <div>
                <ReactEcharts  ref={this.myRef} option={ config } lazyUpdate={true} style={{ height:height||600,width}}></ReactEcharts>
            </div>
        } else
        {
            return null
...
export default WidgetEchartRelation;